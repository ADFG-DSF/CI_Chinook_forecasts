...
rm(list = ls())
brood <- read.csv("H:\\Analyses\\Kenai\\Kenai late run 2024\\KenaiLate2024.csv")
```
...
pred_sib6 <- predict(sib6, newdata = data.frame(age5_ln = log(5214)), se.fit = TRUE)
exp(pred_sib6$fit)
...
#ricker 
tail(brood, 10)
exp(predict(rick6_ar1, 1, newxreg = 17405)[[1]]) * 17405
```
## Age 7 models
...
#ricker 
tail(brood, 10)
exp(predict(rick7_ar1, 1, newxreg = 20583)[[1]]) * 20583
...
dat5CI <- dat5[dat5$ryr %in% 2019:2023, c("ryr", "age5", "univariate_pred")]
dat6CI <- dat6[dat6$ryr %in% 2019:2023, c("ryr", "age6", "es_pred")]
dat7CI <- dat7[dat7$ryr %in% 2019:2023, c("ryr", "age7", "univariate_pred")]
