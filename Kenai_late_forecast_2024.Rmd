...
#Here is the com models function w mape added in.
...
## Age 5 predictions
```{r age 5 predictions, echo=FALSE}
#Moving average model
tail(dat5)
...
## Age 6 predictions
```{r age 6 predictions, echo=FALSE}
#moving average model
tail(dat6)
...
```{r age 7 predictions, echo=FALSE}
#moving average model
tail(dat7)
