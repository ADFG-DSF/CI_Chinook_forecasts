...
# Also notice that the sibling model has been very poor the last 2 years. Also remove from forecast.
...
LR_table <- 
  ...
  autofit()
LR_table
save_as_docx(LR_table, path = ".\\KenaiLR_table.docx")
```
